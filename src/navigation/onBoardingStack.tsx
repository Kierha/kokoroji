...
import OnboardingWelcome from "../screens/onboarding/OnBardingWelcome";
import OnboardingFamily from "../screens/onboarding/OnboardingFamily";
import OnboardingChildren from "../screens/onboarding/OnboardingChildren";
...
export default function OnBoardingStack({ onOnboardingDone }: OnboardingStackProps) {
    return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="OnboardingFamily" component={OnboardingFamily} />
